        ...
        <div class="bg-green-600 border rounded shadow p-2">
            <div class="flex flex-row items-center">
                ...
                <div class="flex-1 text-right">
                    <h5 class="text-white">Total Collection</h5>
                    <h3 class="text-white text-3xl">{{ page.props.data['collection'] }} BDT<span class="text-green-400"><i class="fas fa-caret-down"></i></span></h3>
                </div>
            </div>
        </div>
    </div>
    <div class="w-full md:w-1/2 xl:w-1/3 pt-3 px-3 md:pl-2">
        <div class="bg-blue-600 border rounded shadow p-2">
            <div class="flex flex-row items-center">
                ...
                <div class="flex-1 text-right">
                    <h5 class="text-white">Total Customer</h5>
                    <h3 class="text-white text-3xl">{{ page.props.data['customer'] }} <span class="text-blue-400"><i class="fas fa-caret-up"></i></span></h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-orange-600 border rounded shadow p-2">
            <div class="flex flex-row items-center">
                ...
                <div class="flex-1 text-right pr-1">
                    ...
                    <h3 class="text-white text-3xl">{{ page.props.data['category'] }} <span class="text-orange-400"><i class="fas fa-caret-up"></i></span></h3>
                </div>
            </div>
        </div>
    </div>
    <div class="w-full md:w-1/2 xl:w-1/3 pt-3 px-3 md:pr-2 xl:pr-3 xl:pl-1">
        <div class="bg-yellow-600 border rounded shadow p-2">
            <div class="flex flex-row items-center">
                <div class="flex-shrink pl-1 pr-4"><i class="fas fa-user-plus fa-2x fa-fw fa-inverse"></i></div>
                <div class="flex-1 text-right pr-1">
                    <h5 class="text-white">Vat Collection</h5>
                    <h3 class="text-white text-3xl">{{ page.props.data['vat'] }} BDT<span class="text-orange-400"><i class="fas fa-caret-up"></i></span></h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-purple-600 border rounded shadow p-2">
            <div class="flex flex-row items-center">
                ...
                <div class="flex-1 text-right">
                    ...
                    <h3 class="text-white text-3xl">{{ page.props.data['total'] }} BDT</h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-red-600 border rounded shadow p-2">
            <div class="flex flex-row items-center">
                ...
                <div class="flex-1 text-right">
                    ...
                    <h3 class="text-white text-3xl">{{ page.props.data['invoice'] }} </h3>
                </div>
            </div>
        </div>
    </div>
